...
!function (a, b) {
    ...
    !function () {
        ...
        if (h.style) {
            h.style.backgroundClip = "pages-box", h.cloneNode(!0).style.backgroundClip = "", l.clearCloneStyle = "pages-box" === h.style.backgroundClip, g.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", g.appendChild(h);
            function i() {
            ...
            n.extend(l, {
                pixelPosition: function () {
                    ...
                    return c.style.cssText = h.style.cssText = "-webkit-box-sizing:pages-box;box-sizing:pages-box;display:block;margin:0;border:0;padding:0", c.style.marginRight = c.style.width = "0", h.style.width = "1px", Ea.appendChild(g), b = !parseFloat(a.getComputedStyle(c).marginRight), Ea.removeChild(g), h.removeChild(c), b
                }
            })
        }
    }();
